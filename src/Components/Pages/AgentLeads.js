...
const AgentLeads = () => {
  ...
  const [idd, setIdd] = useState(localStorage.getItem("GetLeadses"));
  ...
  const handleClick = (id) => {
    localStorage.setItem("GetLeadses", id);
    setIdd(id);
  };
                                        ...
                                        <div class="content">
                                          ...
                                          <div class="text-date">
                                            <p class="p-12 text-color-2 lh-18">
                                              ...
                                              Lead Status :{" "}
                                              {data?.lead_status == "1" ? (
                                                <span className="fs-12 fw-6">Lead is Pending</span>
                                              ) : data?.lead_status == "2" ? (
                                                <span className="fs-12 fw-6">Lead is Hold</span>
                                              ) : data?.lead_status == "3" ? (
                                                <span className="fs-12 fw-6">Lead is Fake</span>
                                              ) : (
                                                <span className="fs-12 fw-6">Lead is Sold</span>
                                              )}
                                            </p>
                                          </div>
                                        </div>
