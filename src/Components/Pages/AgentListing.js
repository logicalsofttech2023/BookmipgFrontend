...
const Navigate = useNavigate();
  ...
  useEffect(()=>{
    ...
    const GetDashboard = () =>{
      ...
      axios.post(`${process.env.REACT_APP_API_KEY}website/dashboard`,data).then((res)=>{
  ...
  const GetProperty = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_KEY}website/get_property`, data)
      .then((res) => {
    ...
    swal({
      ...
      if (willDelete) {
        let Statuss = () => {
          ...
          axios
            .post(
              `${process.env.REACT_APP_API_KEY}website/update_property_status`,Data
            )
            .then((res) => {
              GetProperty();
            })
          ...
          <div className="container7">
            <div className="row">
              <div className="col-lg-12">
                <div className="title-group fs-30 lh-45 fw-7">My Listings</div>
              </div>
            </div>
          </div>
        </section>
                  ...
                  <div className="box tf-counter flex bg-white">
                    ...
                    <div className="counter-box one">
                      ...
                      <div className="count-number flex">
                        ...
                        {Dashboarddata?.total_property}/{Dashboarddata?.total_pending} remaining
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                >
                  <div className="new-listing bg-white">
                    ...
                    <div className="sub-text fs-12 lh-18">
                      <span className="one font-2 fw-7">{count}</span> <span>results found</span>
                    </div>
...
{data?.price
  ...
  : `${(data?.rent_amount / 100000)?.toFixed(2)} L`}
                                          </div>
                                        </div>
                                      </div>
                                    </td>
                                      ...
                                      <div className="status-wrap">
                                        ...
                                        "2" ? (
                                          <div className="button-status fs-12 fw-6 lh-18 style-1">
                                            Reject
                                          </div>) : data?.property_approve_status ==
                                        "3" ? (
                                          <div className="button-status fs-12 fw-6 lh-18 style-1">
                                            Sold
                                          </div>) :(
                                    ...
                                    <td>
                                      <div className="icon-wrap">
                                        <ul className>
                                          ...
                                          {data.property_approve_status == "1" ? 
                                          <li className>
                                            <a  onClick={() => {
                                                SoldOutProperty(data?._id);
                                              }}  className="fw-6">
               ...
               <img className="mt-3"
                ...
                <div class="button-footer center mt-3"><Link class="sc-button" to="/AgentProperty"><span>Post Properties Now</span></Link></div>
                </div>
                        )}
                      </div>
