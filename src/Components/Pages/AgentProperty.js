...
const AgentProperty = () => {
  ...
  const Propertiesdata = (e) => {
    ...
    formData.append("maintenance_value", selectedMaintenanceFrequency ? selectedMaintenanceFrequency : "");
    ...
    formData.append("possession_status", possessionStatus ? possessionStatus : "");
    formData.append("furnishing_status", furnishingStatus ? furnishingStatus : "");
    
    formData.append("age_of_property", propertyAge ? propertyAge : "");
    formData.append("no_of_bathroom", numberOfBathrooms ? numberOfBathrooms : "");
    ...
    formData.append("total_floor_count", totalFloorCount ? totalFloorCount : "");
    ...
    formData.append("property_description", propertyDescription ? propertyDescription : "");
