...
const Agents = () => {
  ...
  const [dataofPrefeeredAgent, setdataofPrefeeredAgent] = useState();
  ...
  const GetCityAgent = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_KEY}website/get_city_agent`, data)
      .then((res) => {
        setcount(res?.data?.data?.length);
        setRoletype("All Agents");
        setdataofAgent(res.data.data);
      })
      .catch((error) => {});
  };

  const GetCityPreferredAgent = () => {
    const data = {
      city_name: cityes,
    };
    axios
      .post(`${process.env.REACT_APP_API_KEY}website/get_agent_subscriptions`, data)
      .then((res) => {
        setcount(res?.data?.data?.length);
        setdataofPrefeeredAgent(res?.data?.data);
      })
      .catch((error) => {});
  };
  ...
  const GettopAgent = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_KEY}website/get_top_agent`, data)
      .then((res) => {
  ...
  return (
    <>
      <Toaster />
      <section className="tf-section2 flat-agent flat-property page style bg-23">
        <div className="container6">
          <div className="row flex">
          
              <section
                className="flat-title flat-title52"
                style={{ marginBottom: "-30px" }}
              >
                <div className="container6" style={{ marginBottom: "" }}>
                  <div className="row">
                    <div className="col-lg-12">
                      <div className="title-inner style">
                        ...
                        <div
                          ...
                          className="heading-listing fs-20 lh-45 fw-7"
                        >
                          Property For Real Estate Agents in {cityes}
                        </div>
                        <div className>{count} Agents Found</div>
                         <div className="flat-tabs style2 flex">
                          <div className="box-tab center mb-1 mt-2 bg-white img-box flex justify-content-end align-center">
                            <ul className="menu-tab tab-title flex flex-wrap center">
                              <li
                                style={{ height: "35px" }}
                                className={`flat-bt-top sc-btn-top ${
                                  roletype === "All Agents" ? "active" : ""
                                }`}
                                onClick={() => {
                                  handleRoleChange("All Agents");
                                  GetCityAgent();
                                }}
                              >
                                <h6 className="inner">
                              ...
                              <li
                                ...
                                className={` ${
                                  roletype === "Prefer Agents" ? "active" : ""
                                }`}
                                onClick={() => {
                                  handleRoleChange("Prefer Agents");
                                  GetCityPreferredAgent();
                                }}
                              >
                                <h6 className="inner ">
                                  <svg
            ...
            <div className="col-lg-8 col-md-12"  style={{overflow:'scroll',height:'550px',overflowX:'hidden',scrollbarWidth:'none'}}>
              
             
              
              {roletype === "Prefer Agents" ? (
                dataofPrefeeredAgent?.length > 0 ? (
                  dataofPrefeeredAgent?.map((data) => {
                    return (
                      <div
                        ...
                        >
                          <div className="comment-list">
                            <ol className="">
                              <li className="flex">
                                <div
                                  className="images flex-none flex flex-column justify-content-start align-center"
                                  style={{ marginTop: 20 }}
                                >
                                  {data?.user_image ? (
                                    <img
                                            ...
                                            <span className="star">
                                              ...
                                              >
                                                <g>
                                                  <g>
                                                    <polygon
                                                      points="512,197.816 325.961,185.585 255.898,9.569 
                      ...
                      >
                        <div className="comment-list" >
                          <ol className="" >
                            <li className="flex">
                              <div
                                className="image-author flex-none images flex-none flex flex-column justify-content-start align-center"
                                style={{ marginTop: 20 }}
                              >
                                {data?.user_image ? (
                                  <img
                                ...
                                >
                                  <div className="flex justify-content-between flex-wrap">
                                    ...
                                    <div className="flex" style={{ gap: 10 }}>
                                      ...
                                      >
                                        {data?.language ? data?.language : "No"}
                                      </p>
                                    </div>
                                    {data?.lead_count ? (
                                      <div className="flex" style={{ gap: 10 }}>
