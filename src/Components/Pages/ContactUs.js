...
const ContactUs = () => {
  ...
  const GetContactUs = () => {
    axios
      .get(`${process.env.REACT_APP_API_KEY}website/get_admin_contact_us`)
      .then((res) => {
  ...
  const ContactusDta = (e) => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_KEY}website/add_contact_us`, data)
      .then((res) => {
        swal(res.data.msg, {
          icon: "success",
        });
  ...
  return (
    <>
      <div className="bg-23">
        ...
        <section
          className="flat-contact  page-contact relative"
          style={{ padding: 0 }}
        >
          <div className="container6">
            <div className="row">
        ...
        <section className="flat-contact-page page mt-2 mb-3">
          <div className="container6">
            <div className="row">
              <div className="col-lg-12">
                  ...
                  <div className="respond-comment">
                    ...
                    >
                      <div className="text-wrap flex form-wg">
                        ...
                        <fieldset className="info-box">
                          <label className="fw-6">Phone</label>
                          <input
                            value={Phone}
                            onChange={(e) => {
