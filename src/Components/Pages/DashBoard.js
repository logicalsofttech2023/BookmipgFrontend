...
const DashBoard = () => {
  ...
  return (
    <>
      <div className="body counter-scroll dashboard show">
        <UserSidebar />
                  ...
                  <div class="wrap-count flex-wrap flex">
                    <div class="box tf-counter flex bg-white">
                      ...
                      <div class="counter-box one">
                        <div class="title-count fw-6 fs-16 text-color-4">
                          Your listing
                        </div>
                        <div class="count-number flex">
                          <div
                            ...
                            data-inviewport="yes"
                          ></div>
                          <div class="sub-title fw-6 text-color-4">
                            {Dashboarddata?.total_property}/
            ...
            <div className="container7">
              <div className="row">
                <div className="col-lg-12 flex post-col">
                  <div className="tf-new-listing" style={{
                            overflow: "scroll",
                            height: "500px",
                            overflowX: "hidden",
                            scrollbarWidth: "none",
                                        ...
                                        >
                                          ...
                                          <div className="content">
                                            ...
                                            <div className="money fs-16 fw-6 text-color-3">
                                              ₹
                                              {/* {data?.price ? data?.price : data?.rent_amount} */}
                                              {data?.price
                                                ? `${(
                                                    data?.price / 100000
                                                  )?.toFixed(2)} L`
