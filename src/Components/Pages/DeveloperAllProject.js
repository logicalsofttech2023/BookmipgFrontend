...
const Navigate = useNavigate();
  ...
  const GetDashboard = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_KEY}website/project_dashboard`, data)
      .then((res) => {
  ...
  const GetProperty = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_KEY}website/get_project`, data)
      .then((res) => {
  ...
  let DeleteListing = (item) => {
    swal({
      title: "Are you sure?",
      text: "Once deleted, you will not be able to recover this project listing!",
      icon: "warning",
      buttons: true,
      dangerMode: true,
    }).then((willDelete) => {
      if (willDelete) {
        let DeleteListings = () => {
          ...
          axios
            .get(
              `${process.env.REACT_APP_API_KEY}website/delete_get_project/${item}`
            )
  ...
  let SoldOutProperty = (item) => {
    swal({
      title: "Are you sure?",
      text: "Once sold, you will not be able to change this project status!",
      icon: "warning",
      buttons: true,
      dangerMode: true,
    }).then((willDelete) => {
      if (willDelete) {
        let Statuss = () => {
          ...
          axios
            .post(
              `${process.env.REACT_APP_API_KEY}website/update_project_status`,
              Data
            )
            .then((res) => {
              GetProperty();
        ...
        Statuss();
        swal("Poof! Your project status has been changed!", {
          icon: "success",
        });
      } else {
        swal("Your project status is not changes!");
      }
    });
  };

  const Alertfor = () => {
    swal("Error! Your project can not be sold!", {
      icon: "error",
    });
  };
  ...
  const viewmessage =(item)=>{
    ...
    axios.post(`${process.env.REACT_APP_API_KEY}website/get_project_seller_contact_us`,data).then((res)=>{
  ...
  return (
    <>
      <Toaster />
      <AgentSidebar />
      <div className="dashboard__content bg-23 body counter-scroll dashboard show">
        <section className="flat-title2 ">
          <div className="container7">
            <div className="row">
              <div className="col-lg-12">
                <div className="title-group fs-30 lh-45 fw-7">My Project</div>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="row">
              <div className="col-lg-3 col-sm-12 mb-2">
                <div className="wrap-count flex-wrap flex">
                  <div style={{width:'100%'}} className="box tf-counter flex bg-white">
                  <div className="icons">
            <svg
              width={36}
              height={36}
          ...
          <div className="counter-box one">
            ...
            <div className="count-number flex">
              ...
              <div className="sub-title fw-6 text-color-4">
                {Dashboarddata?.total_project}/
                {Dashboarddata?.total_pending} remaining
              </div>
            </div>
          </div>
                  </div>
          ...
          <div className="container7">
            <div className="row">
              <div className="col-lg-12 flex post-col">
                <div
                  className="tf-new-listing" style={{overflow:'scroll',height:'500px', overflowX:'hidden',scrollbarWidth:'none'}}
                  
                >
                  <div className="new-listing bg-white">
                    <h3 className="titles">New project</h3>
                                  ...
                                  <tr className="file-delete">
                                    <td>
                                      <div style={{cursor:'pointer'}} onClick={() => {
                                                ...
                                                Navigate("/DeveloperprojectDetails")
                                              }}
                                    ...
                                    <td>
                                      <div className="status-wrap">
                                        {data?.project_approve_status == "1" ? (
                                          <div className="button-status fs-12 fw-6 lh-18">
                                            Approved
                                          </div>
                                        ) : data?.project_approve_status ==
                                          "2" ? (
                                        ...
                                        <ul className>
                                          <li className>
                                            <Link onClick={() => 
                                              ...
                                              } to='/Developerprojectupdate'  className="fw-6">
                                          ...
                                          <li className>
                              <a  onClick={() => {
                viewmessage(data?._id);
              }} className=" button-status fs-12 fw-6 lh-18 style-2">{data?.messageCount} Message</a>
                            </li>
                                        </ul>
                                      </div>
                                    </td>
                     ...
                     />
                            <h3>No project post</h3>
                            <div class="button-footer center mt-3"><Link class="sc-button" to="/DeveloperProject"><span>Post Project Now</span></Link></div>
                          </div>
                        )}
                      </div>
  ...
  <div className="messages-sidebar bg-white">
    <h3 className="titles">Messages({length})</h3>

  
    <ul style={{overflow:'scroll',height:'500px', overflowX:'hidden',scrollbarWidth:'none'}}>
...
return(
     <li>
        <div className="image-box flex align-center">
          ...
          <div className="title-flat fw-6">{data?.name}({data?.mobile_no}) <br/>{data?.email}</div>
...
export default DeveloperAllProject;
