...
const DeveloperProjectLeads = () => {
  ...
  const GetProperty = () => {
    ...
    axios
      .post("http://157.66.191.24:3089/website/get_project", data)
      .then((res) => {
  ...
  const [idd, setIdd] = useState(localStorage.getItem("GetLeadsprojected"));
  ...
  const GetLeads = () => {
    ...
    axios
      .post("http://157.66.191.24:3089/website/get_lead_project", data)
      .then((res) => {
  ...
  const handleClick = (id) => {
    localStorage.setItem("GetLeadsprojected", id);
    setIdd(id);
  };
  ...
  const UpdateLeads = (user, item, idd) => {
    ...
    axios
      .post("http://157.66.191.24:3089/website/update_lead_project_status", data)
      .then((res) => {
        GetLeads();
...
export default DeveloperProjectLeads;
