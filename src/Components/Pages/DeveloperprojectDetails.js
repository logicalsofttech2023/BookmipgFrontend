...
const DeveloperprojectDetails = () => {
  ...
  useEffect(()=>{
    GetMessage();
      ...
      const GetMessage =() =>{
        ...
        axios.post("http://157.66.191.24:3089/website/get_project_seller_contact_us",data).then((res)=>{
  ...
  return (
    <> <AgentSidebar />
      <Toaster />
      <section className="flat-title bg-23">
      ...
      <section className="flat-property-detail pt-0 bg-23">
        <div className="container6">
          <div className="row">
            <div className="col-lg-12">
              <div className="wrap-house wg-dream flex">
                <div className="box-1">
                  ...
                  <div className="inner flex">
                    ...
                    {Listingdata?.project_approve_status == "0" ? 
                    <div className="sales fs-12 fw-7 font-2 text-color-1">
                     Pending
                    </div> : Listingdata?.project_approve_status == "1" ? <div className="sales fs-12 fw-7 font-2 text-color-1">
                     Approve
                    </div> : Listingdata?.project_approve_status == "2" ? <div className="sales fs-12 fw-7 font-2 text-color-1">
                     Reject
                  ...
                  <div className="icons icon-1 flex">
                    ...
                    <div className=" icon-1 flex">
                      <span>
                        <i class="far fa-eye"></i></span>{" "}<span className="fw-6">&nbsp;: 0 Views</span>
                    </div>
                ...
                <div className="box-2 text-end">
                  <div className="icon-boxs flex">
                    {favdata?.favourite_status == "1" ? (
                      <a style={{visibility:'hidden'}} onClick={() => addFavorite("0")} href="#">
                        <svg
                          width={20}
                          height={20}
                          viewBox="0 0 18 18"
                      ...
                      <a style={{visibility:'hidden'}} onClick={() => addFavorite("1")} href="#">
                        <svg
                          width={18}
                          height={18}
                          viewBox="0 0 18 18"
                      ...
                      <div className>
                        <div className="inner flex">
                          ...
                          <div className="content">
                            ...
                            <div className="font-2 fw-7">
                              {Listingdata?.minimum_project_size} - {Listingdata?.maximum_project_size
                      ...
                      <div className>
                        <div className="inner flex">
                          ...
                          <div className="content">
                            ...
                            <div className="font-2 fw-7">
                              {Listingdata?.start_price} - {Listingdata?.end_price}
                            </div>
                          </div>
                        </div>
                        <div className="inner flex">
