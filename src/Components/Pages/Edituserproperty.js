...
const Edituserproperty = () => {
  ...
  const Propertiesdata = (e) => {
    ...
    formData.append("explaining_the_property", explaintheproperty);
    ...
    axios
      .post(`http://157.66.191.24:3089/website/update_property`, formData)
      .then((response) => {
        setstatese(true);
  ...
  const GetProperty = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setSelectedProperty(res?.data?.data[0]?.property_listing_type);

        setSelectedPropertyType(res?.data?.data[0]?.building_type_one);
        setSelectedOption(res?.data?.data[0]?.building_type_two);
        setprojectbuildingname(res?.data?.data[0]?.building_name);
        setLocality(res?.data?.data[0]?.locality);
        setprice(res?.data?.data[0]?.price);
        setpropertyrent(res?.data?.data[0]?.rent_amount);
        setSelectedrentValue(res?.data?.data[0]?.rentvalue);
        setRooms(res?.data?.data[0]?.rooms);
        setAreaType(res?.data?.data[0]?.area_type);
        setArea(res?.data?.data[0]?.area);
        setPlotType(res?.data?.data[0]?.plotType);
        setPlotArea(res?.data?.data[0]?.plotArea);
        setRentAmount(res?.data?.data[0]?.rent_amount);
        setSelectedMaintenanceFrequency(res?.data?.data[0]?.maintenance_value);
        setsecurityDeposit(res?.data?.data[0]?.maintenance_value);
        ...
        setPropertyAge(res?.data?.data[0]?.age_of_property);
        setNumberOfBathrooms(res?.data?.data[0]?.no_of_bathroom);
        setRoomCount(res?.data?.data[0]?.no_of_rooms);
        ...
        setPlotNumber(res?.data?.data[0]?.plotNumber);
        setLoanAvailable(res?.data?.data[0]?.loanAvailable);
        setpropertyDescription(res?.data?.data[0]?.property_description);
        ...
        setexplaintheproperty(res?.data?.data[0]?.explaining_the_property);
        ...
        setImages1(res?.data?.data[0]?.images);
      })
      .catch((error) => {});
  };
                            ...
                            {images1?.map((image, index) => (
                              <li key={index} className="file-delete">
                                <img
                                  ...
                                  src={
                                    `http://157.66.191.24:3089/uploads/` + image
                                  }
                                  alt={`Selected ${index}`}
                                />
                                {/* <a
