...
const Hotsellingprojecthome = () => {
  ...
  useEffect(() => {
    if (cityName) { 
      axios
        .post("http://157.66.191.24:3089/website/get_city_project", {
          city_name: "Mumbai",
        })
        .then((response) => setHotdata(response.data.data))
  ...
  return (
    <section  className="flat-blog bg-1 wg-dream home2 dots-style2 pt-5">
          ...
          <div className="col-lg-12">
            ...
            <div className="row">
              <div className="col-md-3">
                <div
                  style={{ boxShadow:'0px 4px 26px 0px rgba(66, 71, 76, 0.0784313725)',
                    height: "365px",
                    borderRadius: "8px",
                    background: "white",
                    padding: "20px",
                ...
                >
                  ...
                  <div>
                    <div className="title-icon fs-20 lh-45 fw-7 text-color-2">
                      You need a house
                    </div>
                    <p>
                      You need a house for your needs. We will give you
                      thousands of suggestions for your dream home. Tell us your
                      needs, and we will give you thousands.
                    </p>
                  </div>
                  <div class="mt-4 cente">
                    <Link
                      to="/ProjectsList"
                      class="sc-button btn-icon"
                  ...
                  {hotdata?.length > 0 && (
                    <>
                      ...
                      <AutoplaySlider
                        ...
                        style={{
                          "--slider-height-percentage": "365px",
                          "--slider-width-percentage": "100%",
                          "--organic-arrow-height": "17px",
                          "--organic-arrow-color": "#333",
                          "--organic-arrow-background-color": "#000",
                          "--animation-duration": "2m",
                          "--control-button-opacity": 1,
                          "--control-button-position": "fixed",
                        }}
                      >
                        {hotdata?.slice(0,5)?.map((slide, index) => (
                          <div   
                            key={index}
                            style={{
                              position: "relative",
                          ...
                          >
                            ...
                            />
                            <div
                              className="overlay-content golo"
                            ...
                            >
                              ...
                              <div  onClick={() => {
                                  ...
                                  Navigate("/ProjectDetails");
                                }} className="money fs-16 fw-8 font-2 text-color-3 mt-1 mb-2">
                                <Link>
                                  ₹ {
                                  (slide?.start_price / 100000)?.toFixed(
                                    2
                                  )} - {(slide?.end_price / 100000)?.toFixed(
                                    2
                                  )} Lac
                                </Link>
                              </div>
                              ...
                              >
                                <div
                                  class="img-box flex align-center"
                                  style={{
                                    padding: "10px",
                                ...
                                >
                                  <div
                                    class="img-author flex align-center "
                                    style={{ gap: "10px" }}
                                  >
                                    <svg
                                      className="svg-original"
                                      width={38}
                                      height={29}
                                      viewBox="0 0 50 50"
                                      fill="none"
                                    ...
                                    <div class="shortInfoBody">
                                      <ul class="value">
                                        ...
                                        <li>{slide?.minimum_configurations} - {slide?.maximum_configurations} {slide?.configurations}</li>
                                      </ul>
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  >
                                    ...
                                    <div class="shortInfoBody">
                                      <ul class="value">
                                        ...
                                        <li>{slide?.minimum_project_size} - {slide?.maximum_project_size} {slide?.project_size}</li>
                                      </ul>
                                    </div>
                                  </div>
                                </div>
...
export default Hotsellingprojecthome;
...
// const slideData = [
//   {
//     src: "http://157.66.191.24:91/assets/images/slider/bg-slider-2.jpg",
//     title: "Luxurious Apartments",
//     description: "Find the best luxurious",
//     amount: "7 Lac to 10 Cr",
//     width: 100,
//   },
//   {
//     src: "https://themesflat.co/html/dreamhomehtml/assets/images/slider/bg-slider-5.jpg",
//     title: "Modern Homes",
//     description: "Explore modern homes",
//     amount: "10 Lac to 15 Cr",
//     width: 100,
//   },
//   {
//     src: "http://157.66.191.24:91/assets/images/slider/bg-slider-2.jpg",
//     title: "Spacious Villas",
//     description: "Get spacious villas.",
//     amount: "6 Lac to 9 Cr",
//     width: 100,
//   },
//   {
//     src: "https://themesflat.co/html/dreamhomehtml/assets/images/slider/bg-slider-3.jpg",
//     title: "Cozy Cottages",
//     description: "Stay cozy in.",
//     amount: "9 Lac to 10 Cr",
//     width: 100,
//   },
// ];
...
//   return (
//     <section className="flat-blog mb-0 bg-1 wg-dream home2 dots-style2 pt-5">
//       <div className="container6">
//         <div className="row">
//           <div className="col-lg-12">
//             <div className="heading-section center mb-4">
...
//                     </p>
//                   </div>
//                   <div class="mt-4 cente"><Link to='/ProjectsList' class="sc-button btn-icon" style={{display:'flex', gap: '40px'}}>&nbsp;&nbsp;&nbsp;

//                   <span>View All</span></Link></div>
...
//                       <div key={index} style={{ position: "relative", borderRadius:'8px' }}>
//                         <img
//                           src={slide.src}
//                           alt={slide.title}
//                           style={{
...
//                         <div style={{ width: "35%" }} class="overlay-content">
...
//                           <div class="money fs-16 fw-8 font-2 text-color-3 mt-1 mb-2">
...
// const slideData = [
//   { src: "http://157.66.191.24:91/assets/images/slider/bg-slider-2.jpg", width: 100 },
//   { src: "https://themesflat.co/html/dreamhomehtml/assets/images/slider/bg-slider-5.jpg", width: 100 },
//   { src: "https://themesflat.co/html/dreamhomehtml/assets/images/slider/bg-slider-4.jpg", width: 100 },
//   { src: "https://themesflat.co/html/dreamhomehtml/assets/images/slider/bg-slider-3.jpg", width: 100 }
// ];
...
//                     </p>
//                   </div>
//                   <div className="button-boxs mt-4 mb-3">
//                     <button
//                       type="button"
//                       className="sc-button"
//                       style={{ borderStyle: "none", color: "#fff" }}
//                     >
//                       <div className="button-search sc-btn-top">View All</div>
//                     </button>
//                   </div>
//                 </div>
//               </div>
