...
const AddCostomer = () => {
  ...
  const [costomerPhone, setCostomerPhone] = useState("");
      ...
      <div className="container-fluid page-body-wrapper">
        ...
        <div className="main-panel">
          <div className="content-wrapper" style={{ marginTop: "50px" }}>
            <div className="page-header">Add Costomer</div>
            <div class="row" data-select2-id="11">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title mb-5">Add Costomer</h4>
                    <Card elevation={3} style={{ boxShadow: "none" }} sx={{ mt: 3, mb: 3 }}>
                <CardContent>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <Grid item xs={12} sm={6}>
                      ...
                      <Grid item xs={12} sm={6}>
                        <TextField
                          label="Costomer Phone"
                          variant="filled"
                          fullWidth
                          value={costomerPhone}
                          onChange={(e) => setCostomerPhone(e.target.value)}
                          required
                        />
                      </Grid>
                      <Grid item xs={12} sm={6}>
                      ...
                      <Grid item xs={12} sm={6}>
                        <FormControl variant="filled" fullWidth>
                          ...
                          >
                            ...
                            <MenuItem value={30}>Connecting rooms</MenuItem>
                      ...
                      <Grid item xs={12} sm={6}>
                        <FormControl variant="filled" fullWidth>
                          ...
                          >
                            ...
                            <MenuItem value={30}>Triple bed rooms</MenuItem>
